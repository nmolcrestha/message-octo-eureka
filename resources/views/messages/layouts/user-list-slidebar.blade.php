<div class="wsus__user_list">
            <div class="wsus__user_list_header">
                ...
                @include('messages.layouts.profile-modal')
            </div>

            @include('messages.layouts.search-form')

            <div class="wsus__favourite_user">
                <div class="top">favourites</div>
                <div class="row favourite_user_slider">
                    @foreach($favourites as $item)
                        <div class="col-xl-3 messenger-item-list" role="button" data-id="{{ $item->favourites->id }}">
                            <a href="#" class="wsus__favourite_item">
                                <div class="img">
                                    <img src="{{ asset($item->favourites->avatar) }}" alt="User" class="img-fluid">
                                    <span class="inactive"></span>
                                </div>
                                <p>{{ $item->favourites->name }}</p>
                            </a>
                        </div>
                    @endforeach
                </div>
            ...
            <div class="wsus__user_list_area">
                ...
                <div class="wsus__user_list_area_height message-contact">
